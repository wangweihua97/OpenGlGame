...
public:
    ...
    /*  函数  */
    Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<Texture2D> textures, int offset, std::vector<VertexBoneData> bones, map<unsigned int, glm::mat4> boneOffsets);
